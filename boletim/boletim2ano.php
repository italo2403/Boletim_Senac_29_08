    ...
    <main>
        <div class="student-info">
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                $sql = "SELECT * FROM alunos2A WHERE nome_aluno LIKE '%$student_name%'";
                ...
                if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
                        ...
                        $aluno_id = $row['aluno_id_2a'];
                        $notas_sql = "SELECT d.nome AS disciplinas_2A, n.unidade, n.av1, n.av2, n.conceito, n.pos_noa
                                      FROM notas_2A n
                                      JOIN disciplinas_2A d ON n.id_disciplina_2A = d.id_disciplina_2A
                                      WHERE n.aluno_id_2a = $aluno_id
                                      ORDER BY n.unidade";
                        ...
                        if ($notas_result->num_rows > 0) {
                            ...
                            while ($nota_row = $notas_result->fetch_assoc()) {
                                $disciplinas[$nota_row['disciplinas_2A']][$nota_row['unidade']] = $nota_row;
                            }
