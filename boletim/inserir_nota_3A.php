...
<div class="menu-lateral">
    ...
    <div class="container">
    <form action="salvar_notas_3A.php" method="POST">
    <?php
    ...
    $sql_alunos = "SELECT * FROM alunos3A";
    ...
    if ($result_alunos->num_rows > 0) {
        ...
        while ($row_aluno = $result_alunos->fetch_assoc()) {
            ...
            echo '<input type="hidden" name="aluno_id_3a[]" value="' . $row_aluno["aluno_id_3a"] . '">'; // Adiciona campo oculto para o ID do aluno

            // Adicionar campo para selecionar a disciplina
echo '<div class="form-group">';
echo '<label for="disciplina_' . $row_aluno["aluno_id_3a"] . '">Disciplina:</label>';
echo '<select id="disciplina_' . $row_aluno["aluno_id_3a"] . '" name="disciplina[]" required>';
