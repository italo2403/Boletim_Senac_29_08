...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST["id_aluno"]) && isset($_POST["unidade"]) && isset($_POST["nota1"]) && isset($_POST["nota2"]) && isset($_POST["conceito"]) && isset($_POST["pos_noa"]) && isset($_POST["disciplina"])) {
        ...
        $sql_insert_notas = "INSERT INTO notas_1A (aluno_id, id_disciplina, unidade, av1, av2, conceito, pos_noa) VALUES (?, ?, ?, ?, ?, ?, ?)";
...
$sql_select_nome = "SELECT nome_aluno FROM alunos1A WHERE aluno_id = ?";
