...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST["aluno_id_3a"]) && isset($_POST["unidade"]) && isset($_POST["nota1"]) && isset($_POST["nota2"]) && isset($_POST["conceito"]) && isset($_POST["pos_noa"]) && isset($_POST["disciplina"])) {
        ...
        $sql_insert_notas = "INSERT INTO notas_3A (aluno_id_3a, id_disciplina, unidade, av1, av2, conceito,  pos_noa) VALUES (?, ?, ?, ?, ?, ?, ?)";
