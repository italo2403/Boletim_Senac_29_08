...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST["aluno_id_3b"]) && isset($_POST["unidade"]) && isset($_POST["nota1"]) && isset($_POST["nota2"]) && isset($_POST["conceito"]) && isset($_POST["pos_noa"]) && isset($_POST["disciplina"])) {
        ...
        $sql_insert_notas = "INSERT INTO notas_3B (aluno_id_3b, id_disciplina, unidade, av1, av2, conceito,  pos_noa) VALUES (?, ?, ?, ?, ?, ?, ?)";
        ...
        if ($stmt) {
            ...
            for ($i = 0; $i < count($_POST["aluno_id_3b"]); $i++) {
                $id_aluno = $_POST["aluno_id_3b"][$i];
...
$sql_select_nome = "SELECT nome_aluno FROM alunos3B WHERE aluno_id_3b = ?";
